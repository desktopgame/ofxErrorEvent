...
meta:
	ADDON_NAME = ofxErrorEvent
	ADDON_DESCRIPTION = ofxErrorEvent is provide easy handling method for OpenGL errors.
	ADDON_AUTHOR = @desktopgame
	ADDON_TAGS = "addon"
	ADDON_URL = http://github.com/desktopgame/ofxErrorEvent
